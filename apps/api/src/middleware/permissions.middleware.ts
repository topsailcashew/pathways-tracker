...
// Role-based permissions mapping — keys must match DB User.role values exactly
export const RolePermissions: Record<string, Permission[]> = {
    ...
    // Integration Team Admin — full access to integrations + team user management
    INTEGRATION_TEAM_ADMIN: [
        Permission.USER_VIEW,
        Permission.USER_CREATE,
        Permission.USER_UPDATE,
    ...
    // Integration Team Member — view and use integrations, no management
    INTEGRATION_TEAM_MEMBER: [
        Permission.MEMBER_VIEW,
