          ...
          <div className="w-full md:w-1/4 flex flex-col gap-6">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col items-center text-center">
                  ...
                  <div className="w-full mt-8 space-y-2">
                      ...
                      <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold text-gray-500 hover:bg-gray-50 transition-all"><IoLogOutOutline size={18} /> Log Out</button>
                  </div>
              </div>
          </div>
          ...
          <div className="w-full md:w-3/4">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 h-full">
                  {activeTab === 'PERSONAL' ? (
                      ...
                      <div className="animate-fade-in"><h3 className="text-xl font-bold text-navy mb-8">Login & Password</h3><p className="text-gray-500">Security settings placeholder.</p></div>
                  )}
              </div>
          </div>
       </div>
